...
function createSseController(sseEndpoint, messagesEndpoint, apiPrefix, guards = [], decorators = []) {
    ...
    let SseController = SseController_1 = class SseController {
        ...
        async sse(res) {
            const transport = new sse_js_1.SSEServerTransport((0, normalize_endpoint_1.normalizeEndpoint)(`${apiPrefix}/${this.applicationConfig.getGlobalPrefix()}/${messagesEndpoint}`), res);
